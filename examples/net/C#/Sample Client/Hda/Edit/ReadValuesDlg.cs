...
namespace OpcClientSdk.Hda.SampleClient
{
	...
	public class ReadValuesDlg : System.Windows.Forms.Form
	{
		...
		private OpcClientSdk.Hda.SampleClient.ItemValuesCtrl ResultsCTRL;
		...
		private void InitializeComponent()
		{
			...
			this.ResultsCTRL = new OpcClientSdk.Hda.SampleClient.ItemValuesCtrl();
		...
		/// </summary>
		private TsCHdaItemValueCollection[] m_results = null;
		...
		private void ItemsCTRL_ResultSelected(OpcItem result)
		{
			...
			{
				ResultsCTRL.Initialize(m_server, (TsCHdaItemValueCollection)result);
			}
		}
	}
}
