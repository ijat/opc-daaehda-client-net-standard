...
namespace OpcClientSdk.Ae.SampleClient
{
	...
	public class MainForm : System.Windows.Forms.Form
	{
		...
		private OpcClientSdk.Ae.SampleClient.ServerStatusCtrl StatusCTRL;
		...
		private OpcClientSdk.Ae.SampleClient.SubscriptionsCtrl SubscriptionsCTRL;
		private System.Windows.Forms.MenuItem menuItem1;
		private System.Windows.Forms.MenuItem CreateSubscriptionMI;
		private OpcClientSdk.Ae.SampleClient.EventListCtrl EventListCTRL;
		...
		static void Main() 
		{
			try
			{
				...
				if (!SecurityManager.IsGranted(permission))
				{
                    ...
                    MessageBox.Show(msg, "OPC AE Client SDK .NET Standard Sample Application");
				}
                ...
                if (IntPtr.Size > 4)
                {
                    ...
                    if (!File.Exists(buffer.ToString()))
                    {
                        ...
                        MessageBox.Show(buffer.ToString(), "OPC AE Client SDK .NET Standard Sample Application");
                    }
                }
		...
		private void InitializeComponent()
		{
			...
			this.SubscriptionsCTRL = new OpcClientSdk.Ae.SampleClient.SubscriptionsCtrl();
			this.RightPN = new System.Windows.Forms.Panel();
			this.EventListCTRL = new OpcClientSdk.Ae.SampleClient.EventListCtrl();
			this.SelectServerCTRL = new SelectServerCtrl();
			this.StatusCTRL = new OpcClientSdk.Ae.SampleClient.ServerStatusCtrl();
            ...
            this.BottomPN.Location = new System.Drawing.Point(3, 555);
            ...
            this.SplitterH.Location = new System.Drawing.Point(3, 552);
            ...
            this.SplitterV.Size = new System.Drawing.Size(3, 500);
            ...
            this.LeftPN.Size = new System.Drawing.Size(264, 500);
            ...
            this.SubscriptionsCTRL.Size = new System.Drawing.Size(264, 497);
			this.SubscriptionsCTRL.TabIndex = 0;
			this.SubscriptionsCTRL.SubscriptionAction += new OpcClientSdk.Ae.SampleClient.SubscriptionsCtrl.SubscriptionActionEventHandler(this.SubscriptionsCTRL_SubscriptionAction);
			// 
			// RightPN
			// 
            ...
            this.RightPN.Size = new System.Drawing.Size(743, 500);
            ...
            this.EventListCTRL.Size = new System.Drawing.Size(743, 497);
			...
			// StatusCTRL
			// 
            this.StatusCTRL.Location = new System.Drawing.Point(3, 655);
            ...
            this.Text = "OPC AE Client SDK .NET Standard Sample Application";
		...
		{
			get { return Application.StartupPath + "\\OpcClientSdk.Ae.SampleClient.config"; }
		}
		...
		private bool OnLoad(bool prompt, OpcClientSdk.OpcUrl url)
		{
			...
			{				
				...
				m_server = (TsCAeServer)new BinaryFormatter().Deserialize(stream);
		...
		private void LoadSettings()
		{
			...
			{				
				...
				{					
					// known urls.
					SelectServerCTRL.Initialize(settings.KnownUrls, settings.SelectedURL, OpcSpecification.OPC_AE_10);
		...
		{
			SelectServerCTRL.Initialize(null, 0, OpcSpecification.OPC_AE_10);
			SaveSettings();
		}
        ...
        {
            Text = String.Format("{0}", "OPC AE Client SDK .NET Standard Sample Application");
        }
